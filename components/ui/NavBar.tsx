  ...
  return (
    <nav className="w-full flex justify-between items-center">
      ...
      <div className="middle hidden md:flex-1 md:flex md:space-x-2 md:px-4 md:justify-around sm:block">
        <Link className="px-2 hover:uppercase underline" href={"/#services"}>
          Services
        </Link>
        <Link className="px-2 hover:uppercase underline" href={"/#toolsNSkills"}>
          Tools/SkillSet
        </Link>
        <Link className="px-2 hover:uppercase underline" href={"/#projects"}>
          Projects
        </Link>
